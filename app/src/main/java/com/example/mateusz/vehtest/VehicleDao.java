...
public interface VehicleDao {
    ...
    void updateTest(long ID, String tDate, String vehMark, String vehEngine, int vehPowerHP, String vehMadeDate, float twenty, float fifty, float seventy, float ninety, float hundred, float avrAcceleration);
    ...
    void updateTestTimes(long ID, float twenty, float fifty, float seventy, float ninety, float hundred);

    @Query("UPDATE TestedVehicle SET  vehicleMark = :vehMark, vehicleEngine = :vehEngine, vehiclePowerHP = :vehPowerHP, vehicleMadeDate = :vehMadeDate WHERE id = :ID")
    void updateVehicleInfo(long ID, String vehMark, String vehEngine, int vehPowerHP, String vehMadeDate);
